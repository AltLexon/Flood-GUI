...
--[Libary]
local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/MidnightScriptz/Floodedv4-UI-/main/source"))()
local venyx = library.new("Flood GUI v4 | Tomato Hub", colors)
...
-- [Tabs/Sections]
local a = venyx:addPage("Auto", 7044226690)
local l = venyx:addPage("Local-Player", 5012544693)
local b = venyx:addPage("Blatant", 7044284832)
local t = venyx:addPage("TAS", 7294901968)
local k = venyx:addPage("Other", 7040410130)
local c = venyx:addPage("Credits", 7252023075)
local auto = a:addSection("Auto")
local loc = l:addSection("Local Player")
local blatant = b:addSection("Blatant")
local tas = t:addSection("Tas")
local other = k:addSection("Other")
local credits = c:addSection("Credits")

other:addKeybind("Toggle UI", Enum.KeyCode.J, function()
	venyx:toggle()
end, function()
end)

other:addButton("Discord | Tomato-Hub Invite", function()
	setclipboard("https://discord.gg/SPaW8nYJW5")
print("Copied to Clipboard Now Go In a Website And Paste The Link To Enter The Server")
clmain.newAlert("Copied To Clipboard Click F9 For More Instructions",nil,nil,"rainbow")
end)

other:addButton("Discord | Lexon Tas Tools", function()
	setclipboard("https://discord.gg/DsmXdCGmA3")
print("Copied to Clipboard Now Go In a Website And Paste The Link To Enter The Server")
clmain.newAlert("Copied To Clipboard Click F9 For More Instructions",nil,nil,"rainbow")
end)

loc:addSlider("Walkspeed", 20, -1, 100, function(t)
	game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = t
end)

loc:addSlider("JumpPower", 50, -1, 200, function(t)
	game.Players.LocalPlayer.Character.Humanoid.JumpPower = t
end)

blatant:addKeybind("Infinite Air", Enum.KeyCode.R, function()
...
blatant:addKeybind("Noclip", Enum.KeyCode.G, function()
...
blatant:addButton("Lag Server", function()
	local key = -game:GetService("ReplicatedStorage").Remote.ReqPasskey:InvokeServer()
	for i = 1, 190, 1 do
...
auto:addToggle("Auto-Play [High XP]", nil, function(t)
	getgenv().play = t
end)
getgenv().play = false
task.spawn(function()
...
blatant:addKeybind("Toggle Keybind", Enum.KeyCode.M, function()
	infjump = not infjump
end)
...
auto:addToggle("Auto-Farm [Low XP]", nil, function(t)
	getgenv().active = t
end)

auto:addToggle("Auto-Vote", nil, function(t)
	getgenv().oof = t
end)

auto:addButton("Get TAS files", function()
...
tas:addButton('Fix TAS', function()
  -- Script made by AltLexon
  loadstring(game:HttpGet('https://pastebin.com/raw/nT12xzMd'))()
end)

tas:addButton("Run-Tas", function()
...
tas:addKeybind("Toggle Swim", Enum.KeyCode.T, function()
	if getgenv().swim == true then
		getgenv().swim = false
	else
		getgenv().swim = true
...
tas:addButton("Remove Water", function()
...
tas:addToggle("Auto-Leave", nil, function(value)
	getgenv().autoleave = t
end)

credits:addButton("New Anti-Kick and Updated by AltLexon", function()
	print("Clicked")
end)


credits:addButton("TAS scripts by Voiz#5668", function()
	print("Clicked")
end)

credits:addButton("TAS File Minifier by iaan#8193", function()
	print("Clicked")
end)

credits:addButton("UI Work By Midnight#8159", function()
	print("Clicked")
end)

credits:addButton("Everything else by Tomato", function()
	print("Clicked")
end)
wait(.1)
clmain.newAlert("Flooded v4 Loaded!",nil,nil,"rainbow")
